...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _updateScoreMatch() {
    ...
    LiveActivities.instance
        .updateLiveActivity(homeScore: homeScore, awayScore: awayScore);
    setState(() {});
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              IconButton(
                  onPressed: _startMatch, icon: const Icon(Icons.play_arrow)),
              IconButton(onPressed: _stopMatch, icon: const Icon(Icons.pause)),
              IconButton(
                  onPressed: _updateScoreMatch, icon: const Icon(Icons.update)),
            ]),
          ],
        ),
      ),
